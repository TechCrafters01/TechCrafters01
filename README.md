# 👨‍💻 TechCrafters01 – Code, Circuits & Cognitive Intelligence 🤖
...
|---------------|----------------------|---------|
| `C/C++`, `C#` , `Java`  , `Python`, `JavaScript`, `TypeScript`, `Go` | `Linux`, `Git`, `Docker`, `VS Code`, `Postman` | `TensorFlow`, `PyTorch`, `OpenCV`, `Scikit-Learn` |
